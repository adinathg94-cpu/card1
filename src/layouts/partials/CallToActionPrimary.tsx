...
const CallToActionPrimary = async ({ isNoSectionTop }: Props) => {
  ...
  let callToAction: CtaPrimarySection = {
    frontmatter: { facts: [], media_section: {} } as any,
    content: "",
  };
  try {
          ...
          <div className="px-7 py-9 lg:py-14 lg:px-14">
            <div className="row justify-center lg:justify-between relative z-20">
              <div className="col-11 lg:col-5">
                <h3
                  ...
                  dangerouslySetInnerHTML={markdownify(
                    callToAction.frontmatter.title
                  )}
                />
                <div className="space-y-5">
                  {callToAction.frontmatter.facts.map((fact: any, i: number) => (
                    <div
                      key={i}
                      data-aos="zoom-in-sm"
              ...
              <div className="lg:col-7 ml-auto">
                <p
                  className="text-balance text-white font-medium text-center lg:text-right max-lg:mt-10 text-[18px] tracking-[0.0005px] leading-[1.69]"
                  dangerouslySetInnerHTML={markdownify(
                    callToAction.frontmatter.description
                  )}
                />
                ...
                <div className="flex flex-col lg:flex-row max-lg:items-center justify-between max-lg:gap-y-6 pt-16">
                  ...
                  <ul className="text-center lg:text-left -space-y-1.5">
                    {callToAction.frontmatter.dialogues?.map(
